    ...
    <div id="page-content">
        <div class="invoice-container">
            ...
            <div class="invoice-header">
                <h1><i class="fa fa-file-text"></i> CONTRIBUTION PAYMENT INVOICE</h1>
            ...
            <!-- ... (rest of the file) ... -->
                ...
                <div class="action-buttons">
                    <a href="<?php echo base_url('admin/contributionpayment/download_invoice/' . $invoice->invoice_id); ?>" 
                    ...
                    <a href="<?php echo base_url('admin/contributionpayment/invoices'); ?>" 
