    ...
    <div id="page-content">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Contribution Payment History by Admin</h3>
            </div>
                ...
                <table class="table table-striped table-hover" id="invoice-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('admin/contributionpayment/invoices_by_admin/' . $summary->paid_by_admin_id); ?>" 
