...
<div id="content-container">
    <div id="page-head">
        <div id="page-title">
            ...
            <div class="searchbox">
                <div class="pull-right">
                    <a href="<?= base_url('offline_contribution/offline_invoice_list') ?>" class="btn btn-default btn-sm btn-labeled">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('offline_contribution/offline_invoice_list') ?>">Invoices</a></li>
