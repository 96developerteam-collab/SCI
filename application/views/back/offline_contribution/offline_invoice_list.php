    ...
    <div id="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow">
                <i class="fa fa-file-text"></i> Offline Contribution Invoices
            </h1>
            <div class="searchbox">
                <div class="pull-right">
                    <a href="<?= base_url('offline_contribution/make') ?>" class="btn btn-primary btn-sm btn-labeled">
    ...
    <div id="page-content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">All Offline Contribution Invoices</h3>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="offline_invoice_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?= base_url('offline_contribution/offline_invoice_detail/' . $inv->id) ?>" 
                                           class="btn btn-sm btn-info" title="View Details">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="<?= base_url('offline_contribution/offline_invoice_pdf/' . $inv->id) ?>" 
