<div id="content-container">
    <div id="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow">Make Offline Payment</h1>
        </div>
        <ol class="breadcrumb">
    ...
    <div id="page-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-right" style="margin-bottom: 20px;">
                     <a href="<?= base_url('offline_payment/offline_invoice_list') ?>" class="custom-btn" style="margin-right: 10px;">
                        <i class="fa fa-file-text"></i> View Invoices
                    </a>
                    <a href="<?= base_url('offline_payment/offline_payment_cart') ?>" class="custom-btn btn-green-gradient">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Select Members for Payment</h3>
            </div>
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        <i class="fa fa-info-circle"></i> No members found available for payment selection.
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
$(document).ready(function () {
    ...
    $('#add_selected_btn').on('click', function () {
        ...
        $.ajax({
            url: '<?= base_url("offline_payment/offline_add_to_cart") ?>',
            type: 'POST',
            data: { 
    ...
    function loadCartCount() {
        $.ajax({
            url: '<?= base_url("offline_payment/offline_get_cart_count") ?>',
            type: 'GET',
            dataType: 'json',
            success: function (res) {
                if (res.success) {
