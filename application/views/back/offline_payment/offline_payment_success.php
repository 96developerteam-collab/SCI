    ...
    <div id="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow">
                <i class="fa fa-check-circle text-success"></i> Payment Successful
            </h1>
        </div>
        <ol class="breadcrumb">
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body text-center" style="padding: 40px;">
                            ...
                            <h2 class="text-success">Payment Processed Successfully!</h2>
                            <p class="lead">Offline payment has been recorded for <?= $invoice->total_members ?> member(s)</p>
                        </div>
                    </div>
                    ...
                    <div class="text-center" style="margin-bottom: 30px;">
                        <a href="<?= base_url('offline_payment/offline_invoice_detail/' . $invoice->id) ?>" 
                        ...
                        <a href="<?= base_url('offline_payment/make') ?>" 
